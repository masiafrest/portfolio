export const sectionDatas = [
  {
    ...
    title: "Sobre mi",
    description:
      "Soy nuevo en esta industria de programacion, mientras he tenido trabajo mayormente como vendedor y logistica, pero siempre he tenido una inclinacion a la informatica, he aprendido varias tecnologia de desarollo empezando por un curso online de la Universidad de Hardvard, Ciencia Computacional CS50, donde el estudiante aprende lenguaje C, JavaScript y Python pero lo mas importante son los concepto y metodologia en el desarollo para resolver un problema en especifico, de alli algunos cursos de curiosidad en Coursera.",
    links: {
